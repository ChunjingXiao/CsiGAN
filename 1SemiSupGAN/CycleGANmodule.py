...
def generator_resnet(image, options, reuse=False, name="generator"):
    ...
    with tf.variable_scope(name):
        ...
        #c0 = tf.pad(image, [[0, 0], [3, 3], [3, 3], [0, 0]], "REFLECT") # c0: 206,36,3
        c0 = tf.pad(image, [[0, 0], [3, 3], [2, 3], [0, 0]], "REFLECT")  # c0: 
        ...
        d2 = tf.pad(d2, [[0, 0], [3, 3], [2, 2], [0, 0]], "REFLECT")
        pred = tf.nn.tanh(conv2d(d2, options.output_c_dim, 7, 1, padding='VALID', name='g_pred_c'))

        return pred

        
def generator_unet(image, options, reuse=False, name="generator"): #  not use this for default
